...
// We can overwrite the object properties in javascript using spread operators
...
// Here thing is spread into the anotherThing but a and e are defined again -> that means it will overwrite the 
// properties a and e in anotherThing (anotherThing alread has inherited these from the thing)
const anotherThing = {
	...thing,
	a:'updated_a',
	e:'updated_e'
...
// since the properties a and e are last defined defined the thing object...we have the a and e from thing overwrite the 
// a and e already defined in otherThing 
const otherThing = {
	a:'updated_a',
	e:'updated_e',
	...thing
